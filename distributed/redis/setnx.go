...
* Created by GoLand.
* @author: clyde
* @date: 2023/7/13 下午2:53
* @note: 基于 Redis 的 setnx 来实现分布式抢占锁

逻辑和单机的 trylock 非常相似，如果获取锁失败，那么相关的任务逻辑就不应该继续向前执行
...
所以，我们需要依赖于这些请求到达 Redis 节点的顺序来做正确地抢锁操作。如果用户的网络环境比较差，那也只能自求多福了。
*/
